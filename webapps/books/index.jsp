...
<body>
    ...
    <div id="createModal" class="modal">
        <div class="modal-content">
            ...
            <form id="createBookForm" onsubmit="submitCreateForm(event)">
                ...
                <div class="form-actions">
                    <button class="btn btn-success">💾 Salvar Livro</button>
    ...
    <script>
        // API Handler URL
        const API_HANDLER = "${pageContext.request.contextPath}/api/books/create.jsp";
    </script>
    <script>
    // ==================== Modal Management ====================
...
function openCreateModal() {
    ...
    document.getElementById("createBookForm").value = ""
}
...
async function deleteBook(id) {
    ...
    try {
        ...
        const url = '/books/api/books/delete.jsp';
...
async function submitCreateForm(event) {
    try {
        ...
        const url = '/books/api/books/create.jsp';
